...
const pluginsData = {
    '3dsmax': [
        ...
        { name: 'Uv tool_VHD', version: '1.0', size: '0.5 MB', file: 'Uv tool_VHD/Uv_tool_VHD.mzp', compat: 'Mọi phiên bản', icon: '🗺️', price: 0, desc: 'Công cụ UV Mapping tự phát triển bởi VHD.', driveLink: 'https://drive.google.com/drive/folders/1sJbS3k5ExmJqqm-G1dwB5MbbchxOfori?usp=sharing' }
    ],
    'autocad': [
